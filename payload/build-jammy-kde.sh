...
EOF
	...
	# source @Gumball9
	run_cmd "apt-mark hold rsyslog"
	install_pkg "software-properties-common"
	run_cmd "add-apt-repository ppa:kubuntu-ppa/backports -y"
	run_cmd "rm /var/lib/dpkg/info/rsyslog.postinst"
	install_pkg "kubuntu-desktop dolphin kconsole plasma-pa plasma-widgets-addons latte-dock -y"
}
